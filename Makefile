...
build-x86_64: $(x86_64_boot_object_files) $(x86_64_asm_object_files)
	...
	mkdir -p dist/x86_64 && \
	x86_64-elf-ld -o dist/x86_64/kernel.bin --unresolved-symbols=report-all --allow-multiple-definition -z noexecstack -T targets/x86_64/linker.ld $(x86_64_asm_object_files) build/kernel/debug/libjos.a build/userspace/debug/libhelloworld.a && \
